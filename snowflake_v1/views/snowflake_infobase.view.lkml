view: snowflake_infobase {
  ...
  dimension: geo_step1 {
    type: string
    sql: CASE WHEN upper(${category}) IN ('GEO') THEN ${statement} else null end;;
    hidden: yes
  }
  ...
  dimension: demo_gender {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('DEMO_GENDER_FEMALE', 'DEMO_GENDER_MALE') THEN  ${statement}
         END;;
  }
...
dimension: gender {
  ...
  dimension: demo_home_ownership {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('DEMO_HOME_OWNER', 'DEMO_HOME_RENTER') THEN  ${statement}
      ELSE NULL END;;
  }
  ...
  dimension: demo_prefer_language{
    hidden: yes
      type:  string
      sql:  CASE WHEN UPPER(${statement}) in ('DEMO_PREFER_LANGUAGE_INDIVIDUAL_BILINGUAL_SPANISH_ENGLISH',
  ...
  dimension: demo_presence_of_children{
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('DEMO_PRESENCE_OF_CHILDREN_N', 'DEMO_PRESENCE_OF_CHILDREN_Y') THEN  ${statement}
      ELSE NULL END;;
  }
  ...
  dimension: demo_household_size {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('DEMO_HH_SIZE_INDIVIDUAL_1',
  ...
  dimension: demo_income {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('DEMO_INCOME_LT_15K_1', 'DEMO_INCOME_15K_20K_1',
  ...
  dimension: demo_occupation {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('DEMO_OCCUPATION_BLUE_COLLAR', 'DEMO_OCCUPATION_HOMEMAKER',
...
dimension: occupation {
 ...
 type: string
  ...
  dimension: demo_marital_status {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('DEMO_MARITAL_STATUS_MARRIED_1', 'DEMO_MARITAL_STATUS_SINGLE_1') THEN  ${statement}
      ELSE NULL END;;
  }
...
dimension: marital_status {
  ...
  dimension: lifestyle_charity_causes_contribute {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('CHARITY_CAUSES_CONTRIBUTE_ARTS_CULTURAL_1YR',
  ...
  dimension: lifestyle_cpg_health_diet {
      hidden: yes
      type: string
      sql: CASE WHEN UPPER(${statement}) IN ('CPG_HEALTH_DIET_GLUTEN_FREE', 'CPG_HEALTH_DIET_HIGH_FIBER',
  ...
  dimension: lifestyle_cpg_pet {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('CPG_PET_OWNER_CAT', 'CPG_PET_OWNER_DOG', 'CPG_PET_TYPE_BIRD',
  ...
  dimension: lifestyle_demo_behavior_affluent {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('DEMO_BEHAVIOR_AFFLUENT_COUPLES_WITHOUT_CHILDREN',
  ...
  dimension: lifestyle_demo_behavior {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('DEMO_BEHAVIOR_DIETERS', 'DEMO_BEHAVIOR_FITNESS_WARRIORS',
  ...
  dimension: lifestyle_demo_life_event {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('DEMO_LIFE_EVENT_ENTERING_ADULTHOOD',
  ...
  dimension: lifestyle_demo_occupation {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('DEMO_OCCUPATION_BLUE_COLLAR', 'DEMO_OCCUPATION_DETAIL_ACCOUNT_EXEC',
  ...
  dimension: finance_finance_affluence {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('FINANCE_AFFLUENCE_HEALTHY', 'FINANCE_AFFLUENCE_MODERATE',
  ...
  dimension: finance_finance {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('FINANCE_BANKING_AFFLUENT_FAMILIES', 'FINANCE_BANKING_AFFLUENT_PRE_RETIRED',
  ...
  dimension: home_home_energy_segment {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('HOME_ENERGY_SEGMENT_BUDGET_WATCHERS', 'HOME_ENERGY_SEGMENT_CREATURES_OF_COMFORT',
  ...
  dimension: insurance_insurance_dynamics {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('INSURANCE_DYNAMICS_COUNTRY_MIDDLES', 'INSURANCE_DYNAMICS_FULL_HOUSE',
  ...
  dimension: interest_attitude_brand_interact {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('ATTITUDE_BRAND_INTERACT_ANONYMITY', 'ATTITUDE_BRAND_INTERACT_CROSS_DEVICE',
  ...
  dimension: interest_interest {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('INTEREST_ADULT_EDUCATION', 'INTEREST_ART_GALLERIES', 'INTEREST_ARTS', 'INTEREST_AUTO_MECHANICS', 'INTEREST_AUTO_SHOWS',
  ...
  dimension: invest_invest_segment {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('INVEST_SEGMENT_AFFLUENT_COUPLES_OR_SINGLES', 'INVEST_SEGMENT_AFFLUENT_FAMILIES_WITH_CHILDREN','INVEST_SEGMENT_AFFLUENT_PRE_RETIRED',
  ...
  dimension: lifestyle_lifestyle_ent {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('LIFESTYLE_ENT_MOVIES_COLLECTOR','LIFESTYLE_ENT_MOVIES_MUSIC','LIFESTYLE_ENT_MOVIES_WATCH_AT_HOME',
  ...
  dimension: lifestyle_lifestyle_green {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('LIFESTYLE_GREEN_LIVING', 'LIFESTYLE_GREEN_SOLAR_ENERGY') THEN  ${statement}
                                    ELSE NULL END;;
  }
  ...
  dimension: lifestyle_lifestyle_in_market {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('LIFESTYLE_IN_MARKET_ENROLL_COOKING','LIFESTYLE_IN_MARKET_EXPECT_GRANDCHILD',
  ...
  dimension: lifestyle_lifestyle_personicx_fin {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('LIFESTYLE_PERSONICX_FIN__FREEWHEELERS','LIFESTYLE_PERSONICX_FIN_ACTIVE_SAVERS','LIFESTYLE_PERSONICX_FIN_ADVENTUROUS_INVESTORS','LIFESTYLE_PERSONICX_FIN_ASKING_ADVICE',
  ...
  dimension: lifestyle_lifestyle_personicx_insurance {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('LIFESTYLE_PERSONICX_INSURANCE_ASPIRING_AFFLUENCE','LIFESTYLE_PERSONICX_INSURANCE_CAREFUL_PLANNERS','LIFESTYLE_PERSONICX_INSURANCE_COMFORTABLE_RENTERS',
  ...
  dimension: lifestyle_lifestyle_personicx_lifestage {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('LIFESTYLE_PERSONICX_LIFESTAGE_ACTIVE_INVOLVED','LIFESTYLE_PERSONICX_LIFESTAGE_ACTIVE_LIFESTYLES','LIFESTYLE_PERSONICX_LIFESTAGE_BUSY_SCHEDULES','LIFESTYLE_PERSONICX_LIFESTAGE_CAREER_BUILDING','LIFESTYLE_PERSONICX_LIFESTAGE_CAREER_CENTERED',
  ...
  dimension: retail_retail_attitude_behavior {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('RETAIL_ATTITUDE_BEHAVIOR_BARGAIN_SHOPPERS','RETAIL_ATTITUDE_BEHAVIOR_DIYERS','RETAIL_ATTITUDE_BEHAVIOR_FASHION_FORWARD',
  ...
  dimension: retail_retail_segment {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('RETAIL_SEGMENT_BEEN_THERE_DONE_THAT','RETAIL_SEGMENT_EYE_ON_ESSENTIALS','RETAIL_SEGMENT_FULL_SPEND_AHEAD','RETAIL_SEGMENT_ITS_MY_LIFE',
  ...
  dimension: tech_tech_social_media {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('TECH_SOCIAL_MEDIA_BUSINESS','TECH_SOCIAL_MEDIA_FACEBOOK_USER','TECH_SOCIAL_MEDIA_LINKEDIN_USER','TECH_SOCIAL_MEDIA_MOBILE_SOCIAL_NETWORKER',
  ...
  dimension: tech_tech_technographic_sement {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('TECH_TECHNOGRAPHIC_SEGMENT_DIGITAL_HOMEFULS','TECH_TECHNOGRAPHIC_SEGMENT_FAST_FORWARD','TECH_TECHNOGRAPHIC_SEGMENT_GADGET_GRABBERS','TECH_TECHNOGRAPHIC_SEGMENT_HANDSHAKERS',
  ...
  dimension: travel_travel_activity {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('TRAVEL_ACTIVITY_AMUSEMENT_PARKS','TRAVEL_ACTIVITY_BEACH_WATERFRONT','TRAVEL_ACTIVITY_BIKING','TRAVEL_ACTIVITY_BOATING','TRAVEL_ACTIVITY_CAMPING','TRAVEL_ACTIVITY_CASINO','TRAVEL_ACTIVITY_CRUISE',
  ...
  dimension: travel_travel_attitude_behavior {
    hidden: yes
    type: string
    sql: CASE WHEN UPPER(${statement}) IN ('TRAVEL_ATTITUDE_BEHAVIOR_AFFLUENT_TRAVELER','TRAVEL_ATTITUDE_BEHAVIOR_CONCERT_GOERS','TRAVEL_ATTITUDE_BEHAVIOR_FAMILY_TRAVELERS',
