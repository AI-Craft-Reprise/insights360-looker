view: audience_definition {
  ...
  dimension: company_size_array {
    ...
    dimension: audience_definition {
      sql: 'Job Function: ' || array_join(${job_function_array}, ', ') || ' Job Seniority: ' || array_join(${job_seniority_array}, ', ') || ' Company: ' || array_join(${country_array}, ', ') || ' Industry: ' || array_join(${industry_array}, ', ') || ' Company Size: ' || array_join(${company_size_array}, ', '|| ' Country: ' || array_join(${country_array});;
