  ...
  dimension: company_size_urn_array {
    ...
    dimension: audience_definition {
      ...
      action: {
        ...
        url: "https://uu2oysvhpdaeh2tlp2sy7khx2u0gvjhd.lambda-url.us-east-1.on.aws?action=request.create&locations=urn:li:geo:103644278&{{ value }}"
        form_url: "https://uu2oysvhpdaeh2tlp2sy7khx2u0gvjhd.lambda-url.us-east-1.on.aws?action=looker.form&locations=urn:li:geo:103644278&{{ value }}"
      }
    }
  }
