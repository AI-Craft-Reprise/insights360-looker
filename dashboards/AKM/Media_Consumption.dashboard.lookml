- dashboard: media_consumption
  ...
  - title: Internet, Social, TV
    ...
    listen:
      ...
      Infobase Version: snowflake_mrisimmons.infobase_version
      Date Created: snowflake_mrisimmons.created
    row: 1
    col: 0
    width: 12
    height: 12
  ...
  - title: Outdoor, Radio/Audio, Newspapers, Magazines
    ...
    filters:
      snowflake_mrisimmons.summaries_grouped: '"Outdoor, Radio/Audio, Newspapers,
        Magazines"'
      snowflake_mrisimmons.question_level_1: MEDIA,media,Media
      snowflake_mrisimmons.question_level_2: SUMMARIES,summaries,Summaries
      snowflake_mrisimmons.question_level_3: MEDIA QUINTILE/TERCILE CODES,media quintile/tercile
        codes,Media Quintile/Tercile Codes
    sorts: [snowflake_mrisimmons.answer]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
  ...
  - title: Top 10 Websites / Apps by %
    ...
    filters:
      snowflake_mrisimmons.question_level_1: MEDIA,Media
      snowflake_mrisimmons.question_level_2: INTERNET,Internet
      snowflake_mrisimmons.question_level_3: WEBSITES VISITED OR APPS USED IN THE
        LAST 30 DAYS,Websites Visited Or Apps Used In The Last 30 Days
  ...
  - title: Top 10 Social Media Visited/ Used by %
    ...
    filters:
      ...
      snowflake_mrisimmons.question_level_3: "%PHOTO OR VIDEO-SHARING SERVICES VISITED\
        \ OR USED IN THE LAST 30 DAYS%,%Photo Or Video-Sharing Services Visited Or\
  ...
  - title: Top 10 Channels/Networks by %
    ...
    filters:
      snowflake_mrisimmons.question_level_1: MEDIA,Media
      snowflake_mrisimmons.question_level_2: TELEVISION,Television
      snowflake_mrisimmons.question_level_3: TELEVISION CHANNELS OR NETWORKS,Television
  ...
  - title: Media Psychographics
    ...
    filters:
      snowflake_mrisimmons.answer: ANY AGREE,Any Agree
  ...
  - name: Date Created
    ...
    model: snowflake_insights_v1
    explore: snowflake_mrisimmons
    listens_to_filters: [Agency, Client, Audience Name]
    field: snowflake_mrisimmons.created
  - name: Infobase Version
    ...
    explore: snowflake_mrisimmons
    listens_to_filters: [Agency, Client, Audience Name]
    field: snowflake_mrisimmons.infobase_version
